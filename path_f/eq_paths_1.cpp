...
int main()
{
   ...
   int l,x1,j;
        ...
        while(i<l)
        {
            ...
            if(!t)///if primary path is good
            {
                ...
                while(j<l)//////////backup first checks
                {
                    ...
                    tmp1=bckup(x,l,weights,i,path_link,tmp1,threshold,v23);
                            //cout<<i<<" "<<tmp1[i][4]<<" "<<threshold<<"\n";
                ...
                while(j<l)//////backup
                {
                    ...
                    if(i==j)
                    {
                        ...
                        continue;
                            ...
                            v23=n[i].rt_pth(j);
                            vector<int>marked(l,0);
                          for(int it=0;it<v23.size();it++)
                          {
                              if(v23.size()!=2&&it==v23.size()-1)break;
                              marked[v23[it]]=1;
                          }
    ...
    st.print_pset(dir1+"Documents/RSA/prim.txt");
    st.print_bset(dir1+"Documents/RSA/bck.txt");
}
